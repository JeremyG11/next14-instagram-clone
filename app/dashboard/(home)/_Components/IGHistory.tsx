...
export function IGHistory() {
  return (
    <section className="w-full flex  items-center">
      <ul className="flex justify-between items-start space-x-3 overflow-x-scroll stories rounded drop-shadow-xl">
          ...
          <div className="bg-gradient-to-tr from-yellow-400 to-fuchsia-600 p-1 rounded-full">
            <a href="#" className="block bg-white p-1 rounded-full relative">
              ...
              <svg
                ...
                className="absolute bottom-0 right-1 border-white border-2 rounded-full"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
